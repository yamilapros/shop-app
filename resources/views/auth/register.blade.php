            ...
            @csrf
              ...
              <div class="card-body">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Nombre...">
                </div>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                ...
                <div class="input-group">
                    ...
                    <input type="password" id="password" class="form-control" placeholder="Confirmar password..." name="password_confirmation" required autocomplete="new-password">
                </div>
              </div>
